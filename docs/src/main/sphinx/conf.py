...
#
# Chunjun documentation build configuration file
#
...
def get_version():
    version = os.environ.get('CHUNJUN_VERSION', '').strip()
...
extensions = ['myst_parser', 'backquote', 'sphinx_copybutton']
...
html_theme_options = {
    ...
    'repo_url': 'https://github.com/DTStack/chunjun',
    'repo_name': 'ChunJun',
